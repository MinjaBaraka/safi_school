<script setup>
    import MainImage from '../../assets/images/first.jpg'
</script>
    ...
    <section class=" bg-center bg-no-repeat bg-cover md:w-auto lg:w-full lg:min-h-[900px]" :style="{ backgroundImage: `url(${MainImage})` }">
            ...
            <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
                ...
                <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                    <a href="" class="inline-flex justify-center items-center py-3 px-5 mb-40 text-base font-medium text-center text-white rounded-lg bg-amber-400 hover:bg-amber-500">
                        Get started
